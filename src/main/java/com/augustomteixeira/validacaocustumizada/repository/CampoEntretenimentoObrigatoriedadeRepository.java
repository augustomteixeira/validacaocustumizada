...
import com.augustomteixeira.validacaocustumizada.model.list.CampoEntretenimentoObrigatoriedade;

@Repository
public interface CampoEntretenimentoObrigatoriedadeRepository extends JpaRepository<CampoEntretenimentoObrigatoriedade, Integer> {
